...
function Login() {
  ...
  const payload = { ...formData, instituteId: id };
  ...
  return (
    <div className="h-screen flex">
      {/* Left Section */}
      <div className="w-1/2 bg-purple-500 flex flex-col justify-center items-center text-white p-8">
        <img
          ...
          <form className="space-y-6" onSubmit={loginHandler}>
            ...
            <div>
              ...
              <input
                ...
                className="w-full rounded-full border border-gray-300 px-4 py-2 focus:outline-none focus:ring-2 focus:ring-purple-400"
            ...
            <button
              type="submit"
              className="w-full rounded-full bg-purple-500 text-white py-2 font-medium hover:bg-purple-600 transition"
            >
